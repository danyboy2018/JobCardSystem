...
require ("php/conn.php");
    ...
    $query = mysqli_query($con,"SELECT * FROM actions");
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="container" >
        <div class="row" >
          <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3" id="box">
            <form action="php/add-employee_server_side.php" method="post">
              <div class="titleBox">
                 <h2> Please Add New Employee </h2>
              </div>
              <hr class="colorgraph">
              <div class="row">
              ...
              <div class="row" id="my_centered_buttons">
                  <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-block btn-lg">Save Employee</button>
                  </div>
              </div>
              <hr class="colorgraph">
            </form>
  ...
  <div class="form-group">
    <div class="col-xs-12 col-sm-6 col-md-6" id="alert">
      <?php
        ...
        if($ok)  {
             echo '<div class="alert alert-success in text-center" role="alert">
