$(document).ready(function(){
    ...
    $('#TableID').on('click','.saveBtn',function () {
        ...
        $.ajax({
            type:'POST',
            url:'http://localhost/php/projects/‏‏edit-projects.php',
            dataType: "json",
            data:'action=edit&id='+ID+'&'+inputData,
            success:function(response){
                if(response.status == 'ok'){
                    alert(response.msg);
                    trObj.find(".editSpan.pname").text(response.data.project_name);

                    trObj.find(".editInput.pname").text(response.data.project_name);
    ...
    $('#TableID').on('click','.confirmBtn',function () {
        ...
        $.ajax({
            type:'POST',
            url:'http://localhost/php/projects/delete-projects.php',
            dataType: "json",
